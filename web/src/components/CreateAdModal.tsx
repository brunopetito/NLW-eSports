...
export const CreateAdModal = () => {
  ...
  async function handleCreateAd(event:React.FormEvent){
    ...
    try{
      ...
      window.alert('Anúncio criado com sucesso!')
    }catch(err){
      console.log(err)
              ...
              <div className="flex flex-col gap-2 flex-1">
                <label htmlFor="hourStart">Qual seu Discord?</label>
                  <div className="grid grid-cols-2 gap-2" >
                    <input name= "hourStart" id='hourStart' type="time" placeholder="De" className="bg-zinc-900 py-3 px-2 rounded text-sm placeholder:text-zin-500 w-23"/> 
                    <input name= "hourEnd" id='hourEnd' type="time" placeholder="Até" className="bg-zinc-900 py-3 px-2 rounded text-sm placeholder:text-zin-500 w-23" />
                  </div>
              </div>
